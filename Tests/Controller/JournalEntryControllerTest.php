...
class JournalEntryControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/finance/journal_entry/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'journalentry[debit]' => 'Lorem ipsum dolor sit amet',
            'journalentry[credit]' => 'Lorem ipsum dolor sit amet',
            'journalentry[date]' => new \DateTime(),
            'journalentry[created]' => new \DateTime(),
            'journalentry[updated]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/finance/journal_entry/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'journalentry[debit]' => 'Changed',
            'journalentry[credit]' => 'Changed',
            'journalentry[date]' => new \DateTime(),
            'journalentry[created]' => new \DateTime(),
            'journalentry[updated]' => new \DateTime(),
