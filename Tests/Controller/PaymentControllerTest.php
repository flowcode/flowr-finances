...
class PaymentControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/finance/payment/');
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/finance/payment/new');
