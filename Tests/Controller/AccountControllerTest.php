...
class AccountControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/finance/account/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'account[code]' => 'Lorem ipsum dolor sit amet',
            'account[name]' => 'Lorem ipsum dolor sit amet',
            'account[type]' => 42,
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/finance/account/new');
